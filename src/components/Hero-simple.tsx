        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start gap-6">
            ...
            <div className="flex items-center gap-4 mt-4">
              ...
              <button
                onClick={() => window.open('https://growvo.stalight.tech/', '_blank')}
                className="bg-purple-600 hover:bg-purple-700 text-white font-medium py-3 px-6 rounded-full transition-all duration-300 hover:shadow-[0_0_20px_rgba(147,51,234,0.5)] relative z-10 flex items-center justify-center group text-sm font-inter"
              >
                Visit Growvo
              </button>
            </div>
